...
public class GuihaitixingController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,GuihaitixingEntity guihaitixing, 
		HttpServletRequest request){
		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("duzhe")) {
			guihaitixing.setDuzhezhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("tushuguanliyuan")) {
			guihaitixing.setGuanlizhanghao((String)request.getSession().getAttribute("username"));
		}
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,GuihaitixingEntity guihaitixing, 
		HttpServletRequest request){
        EntityWrapper<GuihaitixingEntity> ew = new EntityWrapper<GuihaitixingEntity>();
