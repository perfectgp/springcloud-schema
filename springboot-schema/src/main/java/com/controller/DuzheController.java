...
public class DuzheController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		DuzheEntity u = duzheService.selectOne(new EntityWrapper<DuzheEntity>().eq("duzhezhanghao", username));
    ...
    public R register(@RequestBody DuzheEntity duzhe){
    	...
    	DuzheEntity u = duzheService.selectOne(new EntityWrapper<DuzheEntity>().eq("duzhezhanghao", duzhe.getDuzhezhanghao()));
		if(u!=null) {
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<DuzheEntity> wrapper = new EntityWrapper<DuzheEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = duzheService.selectCount(wrapper);
