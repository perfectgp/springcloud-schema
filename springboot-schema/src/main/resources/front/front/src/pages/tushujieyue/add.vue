...
<div :style='{"border":"2px solid #a4d9b7","padding":"20px","margin":"20px auto 0","borderRadius":"8px","flexWrap":"wrap","background":"#fff","width":"1200px","position":"relative"}'>
    ...
    >
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="借阅数量" prop="kucun">
            <el-input v-model="ruleForm.kucun" 
                placeholder="借阅数量" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="借阅时间" prop="jieyueshijian" disabled>
              <el-date-picker
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}'  label="借阅类型" prop="jieyueleixing">
            <el-select v-model="ruleForm.jieyueleixing" placeholder="请选择借阅类型"  >
              <el-option
                  v-for="(item,index) in jieyueleixingOptions"
                  :key="index"
                  :label="item"
                  :value="item">
              </el-option>
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="借阅说明" prop="jieyueshuoming">
            <el-input v-model="ruleForm.jieyueshuoming" 
                placeholder="借阅说明" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="读者账号" prop="duzhezhanghao">
            <el-input v-model="ruleForm.duzhezhanghao" 
                placeholder="读者账号" clearable ></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="读者姓名" prop="duzhexingming">
            <el-input v-model="ruleForm.duzhexingming" 
                placeholder="读者姓名" clearable ></el-input>
          </el-form-item>
      ...
      init(type) {
        ...
        if(type=='cross'){
          ...
          for (var o in obj){
            ...
            if(o=='jieyueleixing'){
              this.ruleForm.jieyueleixing = obj[o];
              this.ro.jieyueleixing = true;
              continue;
            }
            if(o=='jieyueshuoming'){
              this.ruleForm.jieyueshuoming = obj[o];
              this.ro.jieyueshuoming = true;
              continue;
            }
            if(o=='duzhezhanghao'){
        ...
        this.$http.get(this.userTableName + '/session', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
            ...
            if((json.duzhezhanghao!=''&&json.duzhezhanghao) || json.duzhezhanghao==0){
                this.ruleForm.duzhezhanghao = json.duzhezhanghao
            }
            if((json.duzhexingming!=''&&json.duzhexingming) || json.duzhexingming==0){
                this.ruleForm.duzhexingming = json.duzhexingming
            }
          }
        });
        this.jieyueleixingOptions = "线上借阅,线下借阅,提前预定".split(',')
      },
