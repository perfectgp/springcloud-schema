...
<div :style='{"border":"2px solid #a4d9b7","padding":"20px","margin":"20px auto 0","borderRadius":"8px","flexWrap":"wrap","background":"#fff","width":"1200px","position":"relative"}'>
    ...
    >
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="图书文档" prop="tushuwendang">
            <file-upload
            tip="点击上传图书文档"
            action="file/upload"
            :limit="1"
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="图书介绍" prop="tushujieshao">
            <editor 
  ...
  export default {
    ...
    // 多级联动参数
      ...
      tushuwendangUploadChange(fileUrls) {
          this.ruleForm.tushuwendang = fileUrls.replace(new RegExp(this.$config.baseUrl,"g"),"");;
      },
