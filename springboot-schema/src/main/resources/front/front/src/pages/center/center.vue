    ...
    <el-tabs tab-position="left" :style='{"border":"2px solid #a4d9b7","padding":"20px","margin":"20px 0 0 0","borderRadius":"8px","background":"rgba(255,255,255,1)"}' @tab-click="handleClick">
      <el-tab-pane label="个人中心">
        <el-form class="center-preview-pv" ref="sessionForm" :model="sessionForm" :rules="rules" label-width="80px">
          <el-form-item :style='{"padding":"10px","margin":"0 0 4px","background":"none"}' v-if="userTableName=='duzhe'" label="读者账号" prop="duzhezhanghao">
            <el-input v-model="sessionForm.duzhezhanghao" placeholder="读者账号" readonly></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 4px","background":"none"}' v-if="userTableName=='duzhe'" label="密码" prop="mima">
            <el-input type="password" v-model="sessionForm.mima" placeholder="密码"></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 4px","background":"none"}' v-if="userTableName=='duzhe'" label="读者姓名" prop="duzhexingming">
            <el-input v-model="sessionForm.duzhexingming" placeholder="读者姓名" ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 4px","background":"none"}' v-if="userTableName=='duzhe'" label="性别">
            <el-select v-model="sessionForm.xingbie" placeholder="请选择性别" >
              <el-option v-for="(item, index) in dynamicProp.xingbie" :key="index" :label="item" :value="item"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 4px","background":"none"}' v-if="userTableName=='duzhe'" label="手机" prop="shouji">
            <el-input v-model="sessionForm.shouji" placeholder="手机" ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 4px","background":"none"}' v-if="userTableName=='duzhe'" label="身份证" prop="shenfenzheng">
            <el-input v-model="sessionForm.shenfenzheng" placeholder="身份证" ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 4px","background":"none"}' v-if="userTableName=='duzhe'" label="头像">
            <el-upload
              class="avatar-uploader"
              :action="uploadUrl"
              :headers="headers"
              :show-file-list="false"
              :on-success="duzhetouxiangHandleAvatarSuccess">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 4px","background":"none"}' v-if="userTableName=='tushuguanliyuan'" label="管理账号" prop="guanlizhanghao">
            <el-input v-model="sessionForm.guanlizhanghao" placeholder="管理账号" readonly></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 4px","background":"none"}' v-if="userTableName=='tushuguanliyuan'" label="密码" prop="mima">
            <el-input type="password" v-model="sessionForm.mima" placeholder="密码"></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 4px","background":"none"}' v-if="userTableName=='tushuguanliyuan'" label="管理姓名" prop="guanlixingming">
            <el-input v-model="sessionForm.guanlixingming" placeholder="管理姓名" ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 4px","background":"none"}' v-if="userTableName=='tushuguanliyuan'" label="性别">
            <el-select v-model="sessionForm.xingbie" placeholder="请选择性别" >
              <el-option v-for="(item, index) in dynamicProp.xingbie" :key="index" :label="item" :value="item"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 4px","background":"none"}' v-if="userTableName=='tushuguanliyuan'" label="电话" prop="dianhua">
            <el-input v-model="sessionForm.dianhua" placeholder="电话" ></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 4px","background":"none"}' v-if="userTableName=='tushuguanliyuan'" label="头像">
            <el-upload
              class="avatar-uploader"
              :action="uploadUrl"
              :headers="headers"
              :show-file-list="false"
              :on-success="tushuguanliyuantouxiangHandleAvatarSuccess">
              <img :style='{"border":"1px solid #9ce0b5","cursor":"pointer","minHeight":"100px","boxShadow":"inset 0px 0px 48px 0px #cef1db","color":"#3db769","borderRadius":"6px","textAlign":"center","width":"150px","fontSize":"32px","lineHeight":"100px","height":"auto"}' v-if="sessionForm.touxiang" :src="baseUrl + sessionForm.touxiang" class="avatar">
              <i v-else class="el-icon-plus avatar-uploader-icon"></i>
            </el-upload>
          </el-form-item>
...
<script>
  ...
  export default {
    ...
    created() {
      if ('duzhe' == this.userTableName) {
        this.$set(this.sessionForm, 'duzhezhanghao', null);
      }
      if ('duzhe' == this.userTableName) {
        this.$set(this.sessionForm, 'mima', null);
      }
      if ('duzhe' == this.userTableName) {
        this.$set(this.sessionForm, 'duzhexingming', null);
      }
      if ('duzhe' == this.userTableName) {
      ...
      if ('tushuguanliyuan' == this.userTableName) {
      ...
      if ('duzhe' == this.userTableName) {
        this.$set(this.rules, 'duzhezhanghao', [{ required: true, message: '请输入读者账号', trigger: 'blur' }]);
      }
      if ('duzhe' == this.userTableName) {
        this.$set(this.rules, 'mima', [{ required: true, message: '请输入密码', trigger: 'blur' }]);
      }
      if ('duzhe' == this.userTableName) {
        this.$set(this.rules, 'duzhexingming', [{ required: true, message: '请输入读者姓名', trigger: 'blur' }]);
      }
			if ('duzhe' == this.userTableName) {
    ...
    methods: {
      ...
      duzhetouxiangHandleAvatarSuccess(res, file) {
        if (res.code == 0) {
          if ('duzhe' == this.userTableName) {
      ...
      tushuguanliyuantouxiangHandleAvatarSuccess(res, file) {
        if (res.code == 0) {
          if ('tushuguanliyuan' == this.userTableName) {
            this.sessionForm.touxiang = 'upload/' + res.file;
          }
