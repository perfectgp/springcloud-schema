	...
	<div class="detail-preview" :style='{"width":"1200px","padding":"0 0 20px","margin":"0px auto","position":"relative","background":"none"}'>
		<div class="attr" :style='{"border":"2px solid #a4d9b7","padding":"20px","margin":"20px 0 0 0","overflow":"hidden","borderRadius":"8px","flexWrap":"wrap","background":"#fff","display":"flex","position":"relative","justifyContent":"space-between","height":"auto"}'>
			...
			<div class="info" :style='{"minHeight":"570px","padding":"0 20px 20px","margin":"0px","borderRadius":"8px","background":"#f9f9f9","width":"600px","height":"auto","order":"2"}'>
				...
				<div class="item" :style='{"padding":"4px","margin":"0 0 4px 0","borderColor":"rgba(85, 180, 75,.4)","background":"none","borderWidth":"0 0 1px 0 ","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px 0 0","color":"#333","textAlign":"left","width":"130px","fontSize":"14px","lineHeight":"24px","fontWeight":"bold","height":"40px"}'>库存</div>
					<div  :style='{"width":"498px","padding":"0 10px","fontSize":"14px","lineHeight":"24px","color":"#666"}'>{{detail.kucun}}</div>
				</div>
				<div class="item" :style='{"padding":"4px","margin":"0 0 4px 0","borderColor":"rgba(85, 180, 75,.4)","background":"none","borderWidth":"0 0 1px 0 ","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px 0 0","color":"#333","textAlign":"left","width":"130px","fontSize":"14px","lineHeight":"24px","fontWeight":"bold","height":"40px"}'>图书文档</div>
					<el-button :style='{"padding":"0px 10px","margin":"0px","color":"#ffff","borderRadius":"20px","textAlign":"center","background":"rgb(85, 180, 75)","width":"100px","lineHeight":"40px","fontSize":"14px","textDecoration":"none","height":"40px"}' @click="download(detail.tushuwendang)">点击下载</el-button>
				</div>
				<div class="btn" :style='{"padding":"10px 0 0","flexWrap":"wrap","display":"flex"}'>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0px 5px 5px 0","outline":"none","color":"#383838","borderRadius":"4px","background":"#acd598","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="isAuth('tushuxinxi','图书借阅')" @click="onAcross('tushujieyue','','','')" type="warning">图书借阅</el-button>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0px 5px 5px 0","outline":"none","color":"#383838","borderRadius":"4px","background":"#acd598","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="isAuth('tushuxinxi','图书入库')" @click="onAcross('tushuruku','','','')" type="warning">图书入库</el-button>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0px 5px 5px 0","outline":"none","color":"#383838","borderRadius":"4px","background":"#acd598","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' v-if="isAuth('tushuxinxi','图书盘点')" @click="onAcross('tushupandian','','','')" type="warning">图书盘点</el-button>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0px 5px 5px 0","outline":"none","color":"#383838","borderRadius":"4px","background":" #a8c2e5","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' @click="freeReadClick" type="success">免费试读</el-button>
				</div>
			</div>
...
<script>
  ...
  export default {
    ...
    methods: {
        ...
        freeReadClick(){
            this.$router.push(('/index/tushuxinxiChapter?id=' + this.freeChapterList[0].id))
        },
        chapterClick(vipread,id){
            ...
            this.$router.push(('/index/tushuxinxiChapter?id=' + id))
        },
        getFreeChapterList() {
      ...
      storeup(type) {
        if (type == 1 && !this.isStoreup) {
          ...
          this.storeupParams.inteltype = this.detail.tushuleixing;
    ...
    getThumbsupOrCrazilyStatus() {
        if(localStorage.getItem("Token")) {
            this.$http.get('storeup/list', {params: {page: 1, limit: 1, type: 21, refid: this.detail.id, tablename: 'tushuxinxi', userid: localStorage.getItem('userid')}}).then(res => {
              if (res.data.code == 0 && res.data.data.list.length > 0) {
            ...
            this.$http.get('storeup/list', {params: {page: 1, limit: 1, type: 22, refid: this.detail.id, tablename: 'tushuxinxi', userid: localStorage.getItem('userid')}}).then(res => {
              if (res.data.code == 0 && res.data.data.list.length > 0) {
