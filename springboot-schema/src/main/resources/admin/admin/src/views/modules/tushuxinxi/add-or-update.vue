	...
	<div class="addEdit-block" :style='{"padding":"30px","backgroundAttachment":"fixed","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20230312/52c1bcab43064c72aa492e0f342d2666.jpg)","flexDirection":"row-reverse","display":"flex","backgroundSize":"cover","backgroundPosition":"center center","backgroundRepeat":"no-repeat","height":"calc(100vh - 120px)"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="图书类型" prop="tushuleixing">
					<el-select :disabled="ro.tushuleixing" v-model="ruleForm.tushuleixing" placeholder="请选择图书类型" >
						<el-option
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="upload" v-if="type!='info'&& !ro.tushuwendang" label="图书文档" prop="tushuwendang">
					<file-upload
						tip="点击上传图书文档"
						action="file/upload"
						:limit="1"
						:multiple="true"
						:fileUrls="ruleForm.tushuwendang?ruleForm.tushuwendang:''"
						@change="tushuwendangUploadChange"
					></file-upload>
				</el-form-item>  
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else-if="ruleForm.tushuwendang" label="图书文档" prop="tushuwendang">
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 25px","margin":"0 20px 0 0","outline":"none","color":"rgba(255, 255, 255, 1)","borderRadius":"0","background":"#67D4B2","width":"auto","lineHeight":"40px","fontSize":"14px","height":"40px"}' type="text" size="small" @click="download($base.url+ruleForm.tushuwendang)">下载</el-button>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else-if="!ruleForm.tushuwendang" label="图书文档" prop="tushuwendang">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.tushufengmian" label="图书封面" prop="tushufengmian">
					<file-upload
						tip="点击上传图书封面"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.tushufengmian" label="图书封面" prop="tushufengmian">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-if="type!='info'"  label="图书介绍" prop="tushujieshao">
					<editor 
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else-if="ruleForm.tushujieshao" label="图书介绍" prop="tushujieshao">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#000","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.tushujieshao"></span>
                </el-form-item>
...
export default {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='tushuwendang'){
							this.ruleForm.tushuwendang = obj[o];
							this.ro.tushuwendang = true;
							continue;
						}
						if(o=='tushujieshao'){
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.tushujieshao = this.ruleForm.tushujieshao.replace(reg,'../../../springcloudha1ml/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
	...
	if(this.ruleForm.tushuwendang!=null) {
		this.ruleForm.tushuwendang = this.ruleForm.tushuwendang.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
    ...
    tushuwendangUploadChange(fileUrls) {
	    this.ruleForm.tushuwendang = fileUrls;
    },
