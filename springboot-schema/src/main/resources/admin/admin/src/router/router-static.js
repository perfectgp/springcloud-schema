...
import center from '@/views/center'
    ...
    import tushupandian from '@/views/modules/tushupandian/list'
    import chaptertushuxinxi from '@/views/modules/chaptertushuxinxi/list'
    import tushuleixing from '@/views/modules/tushuleixing/list'
    import guihaitixing from '@/views/modules/guihaitixing/list'
    import discusstushuxinxi from '@/views/modules/discusstushuxinxi/list'
    import forum from '@/views/modules/forum/list'
    import tushuguanliyuan from '@/views/modules/tushuguanliyuan/list'
    import tushujieyue from '@/views/modules/tushujieyue/list'
    import tushuruku from '@/views/modules/tushuruku/list'
...
const routes = [{
	...
	path: '/tushupandian',
      ...
      ,{
	path: '/chaptertushuxinxi',
        name: '图书信息章节',
        component: chaptertushuxinxi
      }
      ,{
	path: '/tushuleixing',
        name: '图书类型',
